...
import { Container , Table } from "../styled-components/HomeStyling";

const Home = () => {
  return (
    <Container>
      <h1>Nasa Astronauts Fullstack Project</h1>
      ...
      <a href="https://express-api-technigo.herokuapp.com/">Backend API link</a>
      ...
      <a href="https://savannah-astronauts-frontend.netlify.app/">Frontend link</a>
      ...
      <p>/api/astronauts?name=&#123;name&#125;&status=&#123;status&#125;&mission=&#123;mission&#125;&gender=
        &#123;gender&#125;&major=&#123;major&#125;&graduateMajor=&#123;graduateMajor&#125;</p>
      <Table>{renderTableData(queryParametersOne)}</Table>
      <p>/api/year/:year?gender=&#123;gender&#125;&group=&#123;group&#125;&spaceFlights=&#123;spaceFlights&#125;
        &spaceHours=&#123;spaceHours&#125;&spaceWalks=&#123;spaceWalks&#125;&walksHours=&#123;walksHours&#125;</p>
